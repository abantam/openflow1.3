...
add wave -noupdate -format logic /demo_tb/rgmii_txc
add wave -noupdate -format logic /demo_tb/rgmii_tx_ctl
add wave -noupdate -format logic -hex /demo_tb/rgmii_txd
add wave -noupdate -divider {Rx RGMII Interface}
add wave -noupdate -format logic /demo_tb/rgmii_rxc
add wave -noupdate -format logic /demo_tb/rgmii_rx_ctl
add wave -noupdate -format logic -hex /demo_tb/rgmii_rxd
